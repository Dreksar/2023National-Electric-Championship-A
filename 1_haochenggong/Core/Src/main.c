...
#define kp_q       -7.4f  //-5.f                并网逆变10v 1A分配kp_q=-9.f  ki_q=-0.08f
#define ki_q       -0.3f   //-20.0f
#define kp_d       -7.4f   //-12.5f                                             //-12.5f
#define ki_d       -0.3f  //-5.f                                                 //-5.f
CLECK Cleck,Cleck_1;
PARK  Park;
AD_Detc AD_buf;
extern PLL p;
...
float Iset;
float IoutT;
float id_tar  =   -1.414f*1.f;
uint8_t qiehuan_flag=2;
float x=0.817f;          //0.817
/* USER CODE END PTD */
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
		...
		switch(key1)
		{
			...
			case 4:  
						qiehuan_flag=0;
						OLED_ShowStr(39,0,"Slave ",2);
						OLED_ON();	
			break;
			case 5:
						qiehuan_flag=1;
						OLED_ShowStr(39,0,"Master",2);
						OLED_ON();	
			break;
			case 6:
						qiehuan_flag=2;
